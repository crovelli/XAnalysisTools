...
// Tue Apr 19 10:26:58 2022 by ROOT version 6.24/06
// from TTree Events/Events
// found on file: /eos/cms/store/group/phys_egamma/crovelli/LowPtEle/B0ToXKs_2022Apr14/BdToX3872Ks_X3872ToJpsiRho_BMuonFilter_DGamma0_TuneCUEP8M1_13TeV-pythia8-evtgen/crab_BdToX3872Ks/220414_145640/0000/xNANO_mc_2022Apr14_1.root
//////////////////////////////////////////////////////////
...
class XBase {
 public :
  ...
  Int_t           B0_K0s_matchTrack1_fired_DoubleMu4_JpsiTrkTrk_Displaced[500];   //[nB0]
  Int_t           B0_K0s_matchTrack1_fired_DoubleMu4_JpsiTrk_Displaced[500];   //[nB0]
  Int_t           B0_K0s_matchTrack1_fired_DoubleMu4_PsiPrimeTrk_Displaced[500];   //[nB0]
  Int_t           B0_K0s_matchTrack2_fired_DoubleMu4_JpsiTrkTrk_Displaced[500];   //[nB0]
  Int_t           B0_K0s_matchTrack2_fired_DoubleMu4_JpsiTrk_Displaced[500];   //[nB0]
  Int_t           B0_K0s_matchTrack2_fired_DoubleMu4_PsiPrimeTrk_Displaced[500];   //[nB0]
  Int_t           B0_MuMu_mu1_fired_Dimuon18_PsiPrime[500];   //[nB0]
  Int_t           B0_MuMu_mu1_fired_Dimuon25_Jpsi[500];   //[nB0]
  Int_t           B0_MuMu_mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced[500];   //[nB0]
  Int_t           B0_MuMu_mu1_fired_DoubleMu4_JpsiTrk_Displaced[500];   //[nB0]
  Int_t           B0_MuMu_mu1_fired_DoubleMu4_PsiPrimeTrk_Displaced[500];   //[nB0]
  Int_t           B0_MuMu_mu2_fired_Dimuon18_PsiPrime[500];   //[nB0]
  Int_t           B0_MuMu_mu2_fired_Dimuon25_Jpsi[500];   //[nB0]
  Int_t           B0_MuMu_mu2_fired_DoubleMu4_JpsiTrkTrk_Displaced[500];   //[nB0]
  Int_t           B0_MuMu_mu2_fired_DoubleMu4_JpsiTrk_Displaced[500];   //[nB0]
  Int_t           B0_MuMu_mu2_fired_DoubleMu4_PsiPrimeTrk_Displaced[500];   //[nB0]
  Int_t           B0_PiPi_p1_fired_DoubleMu4_JpsiTrkTrk_Displaced[500];   //[nB0]
  Int_t           B0_PiPi_p1_fired_DoubleMu4_JpsiTrk_Displaced[500];   //[nB0]
  Int_t           B0_PiPi_p1_fired_DoubleMu4_PsiPrimeTrk_Displaced[500];   //[nB0]
  Int_t           B0_PiPi_p2_fired_DoubleMu4_JpsiTrkTrk_Displaced[500];   //[nB0]
  Int_t           B0_PiPi_p2_fired_DoubleMu4_JpsiTrk_Displaced[500];   //[nB0]
  Int_t           B0_PiPi_p2_fired_DoubleMu4_PsiPrimeTrk_Displaced[500];   //[nB0]
  ...
  UInt_t          nProbeTracks;
  Float_t         ProbeTracks_d0sig[9000];   //[nProbeTracks]
  ...
  Int_t           ProbeTracks_fired_HLT_DoubleMu4_JpsiTrkTrk_Displaced[9000];   //[nProbeTracks]
  Int_t           ProbeTracks_fired_HLT_DoubleMu4_JpsiTrk_Displaced[9000];   //[nProbeTracks]
  Int_t           ProbeTracks_fired_HLT_DoubleMu4_PsiPrimeTrk_Displaced[9000];   //[nProbeTracks]
...
XBase::XBase(TTree *tree) : fChain(0) 
{
  ...
  if (tree == 0) {
    TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/group/phys_egamma/crovelli/LowPtEle/B0ToXKs_2022Apr14/BdToX3872Ks_X3872ToJpsiRho_BMuonFilter_DGamma0_TuneCUEP8M1_13TeV-pythia8-evtgen/crab_BdToX3872Ks/220414_145640/0000/xNANO_mc_2022Apr14_1.root");
    if (!f || !f->IsOpen()) {
      f = new TFile("/eos/cms/store/group/phys_egamma/crovelli/LowPtEle/B0ToXKs_2022Apr14/BdToX3872Ks_X3872ToJpsiRho_BMuonFilter_DGamma0_TuneCUEP8M1_13TeV-pythia8-evtgen/crab_BdToX3872Ks/220414_145640/0000/xNANO_mc_2022Apr14_1.root");
    }
